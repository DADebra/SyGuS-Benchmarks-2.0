...
(define-fun trans-fn ((x (Array Int Int)) (c Int) (x! (Array Int Int)) (c! Int)) Bool
    (and (forall ((index Int)) (ite (= (select x index) 10) (= (select x! index) 10) (= (select x! index) (+ (select x index) 1)))) (= c! c)))
(define-fun post-fn ((x (Array Int Int)) (c Int)) Bool
    (exists ((index Int)) (=> (>= index 0) (and (= (select x index) 10) (forall ((index2 Int)) (=> (and (>= index2 0) (< index2 index)) (not (= (select x index2) 10))))))))
