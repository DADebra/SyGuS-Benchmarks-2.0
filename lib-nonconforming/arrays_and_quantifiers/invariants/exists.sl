...
(define-fun init-fn ((x (Array Int Int))) Bool
    (and (exists ((index Int)) (= (select x index) 1)) (exists ((index Int)) (= (select x index) 0))))
(define-fun trans-fn ((x (Array Int Int)) (x! (Array Int Int))) Bool
    (forall ((index Int)) (ite (= (select x index) 0) (= (select x! index) 1) (ite (= (select x index) 1) (= (select x! index) 0) (= (select x! index) (select x index))))))
