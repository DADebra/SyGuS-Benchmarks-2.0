...
(define-fun trans-fn ((x (Array Int Int)) (y (Array Int Int)) (x! (Array Int Int)) (y! (Array Int Int))) Bool
    (forall ((index Int)) (and (= (select x! index) (+ (select y index) 1)) (= (select y! index) (+ (select x index) 1)))))
