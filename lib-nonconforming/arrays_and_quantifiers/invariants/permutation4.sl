...
(define-fun init-fn ((a (Array Int Int)) (b (Array Int Int))) Bool
    (= a b))
(define-fun trans-fn ((a (Array Int Int)) (b (Array Int Int)) (a! (Array Int Int)) (b! (Array Int Int)) (idx1 Int) (idx2 Int)) Bool
    (and (= a! (store (store a 1 (select a 0)) 0 (select a 1))) (= b! b)))
(define-fun post-fn ((a (Array Int Int)) (b (Array Int Int))) Bool
    (forall ((index1 Int)) (=> (< index1 2) (exists ((index2 Int)) (= (select a index1) (select b index2))))))
