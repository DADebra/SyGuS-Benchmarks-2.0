...
(define-fun init-fn ((i Int) (x (Array Int Int))) Bool
    (and (> i 0) (forall ((index Int)) (= (select x index) 10))))
(define-fun trans-fn ((i Int) (x (Array Int Int)) (i! Int) (x! (Array Int Int))) Bool
    (and (= i! i) (forall ((index Int)) (ite (< (select x index) 100) (= (select x! index) (+ (select x index) i)) (= (select x! index) (select x index))))))
