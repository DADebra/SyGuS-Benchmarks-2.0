...
(define-fun init-fn ((x (Array Int Int)) (y (Array Int Int)) (c1 Int)) Bool
    (and (forall ((index Int)) (= (select y index) 10)) (forall ((index Int)) (= (select x index) 10))))
(define-fun trans-fn ((x (Array Int Int)) (y (Array Int Int)) (c1 Int) (x! (Array Int Int)) (y! (Array Int Int)) (c1! Int)) Bool
    (and (forall ((index Int)) (and (= (select x! index) (+ (select y index) c1)) (= (select y! index) (+ (select x index) c1)))) (= c1! c1)))
