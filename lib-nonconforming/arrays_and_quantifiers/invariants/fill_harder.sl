...
(define-fun trans-fn ((c Int) (k Int) (x (Array Int Int)) (c! Int) (k! Int) (x! (Array Int Int))) Bool
    (and (forall ((index Int)) (= (select x! index) (+ (select x index) 1))) (= c! (+ c 1))))
(define-fun post-fn ((c Int) (x (Array Int Int))) Bool
    (exists ((index Int)) (and (= (select x index) c) (forall ((index2 Int)) (=> (and (>= index2 0) (< index2 index)) (= (select x index2) c))))))
