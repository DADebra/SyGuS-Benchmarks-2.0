...
(define-fun trans-fn ((a (Array Int Int)) (alength Int) (i Int) (max Int) (i! Int) (max! Int)) Bool
    (ite (< i alength) (and (ite (> (select a i) max) (= max! (select a i)) (= max! max)) (= i! (+ i 1))) (and (= i! i) (= max! max))))
(define-fun post-fn ((a (Array Int Int)) (alength Int) (i Int) (max Int)) Bool
    (=> (and (<= 0 alength) (exists ((index Int)) (and (<= 0 index) (< index i) (<= 0 (select a index))))) (exists ((index2 Int)) (and (<= 0 index2) (< index2 i) (= (select a index2) max)))))
